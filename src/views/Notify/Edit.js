...
import { Form, Input, Button, Card, Row, Col, Modal, Comment, List, Avatar, Select, Typography, Checkbox } from 'antd';
...
class NotifyEdit extends Component {
    ...
    getTicketInfo = (id) => {
        getTicket(id).then(res => {
            ...
            temp.push(`${mapFiledToChinese['create_time']}: ${res.message['create_time']}`)
                ...
                <Card title="工单详情" extra={ this.TicketButtonGroup() }>
                    <Col span={16} offset={4}>
                        <Form
                            ...
                            layout="inline"
                        >
                            <Form.Item name="status" label={<b style={{ color: '#08c' }}>工单状态</b>}>
