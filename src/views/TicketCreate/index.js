        ...
        <Form {...layout} form={form} name="control-hooks" onFinish={onFinish}>
            ...
            >
                ...
                >
                    <TreeNode
                        value="sre"
                        disabled={true}
                        title={<b style={{ color: '#08c' }}>sre</b>}
                    >
                        <TreeNode
                            value="sre-infrastructure"
                            disabled={true}
                            title={<b style={{ color: '#08c' }}>基础设施</b>}
                        >
                            <TreeNode
                                value="sre-infrastructure-aws-resource"
                                title="AWS 资源申请"
                            ></TreeNode>
                        </TreeNode>
                        <TreeNode
                            value="sre-network"
                            disabled={true}
                            title={<b style={{ color: '#08c' }}>办公网</b>}
                        >
                            <TreeNode
                                value="sre-network-wifi"
                                title="WIFI 认证失败"
                            ></TreeNode>
                            <TreeNode
                                value="sre-network-vpn"
                                title="密码重置"
                            ></TreeNode>
                            <TreeNode
                                value="sre-network-office"
                                title="办公网网络不稳定"
                            ></TreeNode>
                        </TreeNode>
                    </TreeNode>
                    <TreeNode
                        value="bigdata"
                        disabled={true}
                        title={<b style={{ color: '#08c' }}>bigdata</b>}
                    >
            ...
            <Form.Item
                ...
                shouldUpdate={(prevValues, currentValues) =>
                    prevValues.tikectType !== currentValues.tikectType
                }
            >
                {({ getFieldValue }) => {
