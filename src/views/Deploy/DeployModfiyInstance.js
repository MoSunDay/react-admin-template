...
import { getServiceVersionInstanceNumber, setServiceVersionInstanceNumber } from '../../api'
...
class DeployModfiyInstance extends Component {
  ...
  onMidfiy = () => {
    ...
    const response = setServiceVersionInstanceNumber(this.state.serviceVersion, this.state.instanceNumber);
    response
      .then((res) => {
